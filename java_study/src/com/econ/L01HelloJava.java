package com.econ;
// package 를 작성하면 java 문서를 컴파일 할 때 bin폴더 하위에 동일한 위치에 class를 생성
// 장점1 : 컴파일 시 오류를 잡기 때문에 오류없는 어플을 배포
// 장점2 : 컴파일된 문서는 컴퓨터가 해석하기 쉬운 언어기(바이너리 코드) 때문에 실행이 빠르다.
...
public class L01HelloJava {
	...
	// main은 jre(Java Runtime Environment) -> JAVA를 실행하는 가상 머신
	...
	public static void main(String[] args) {
		...
		// java는 OS의 지원(System)을 사용할 수 있는 가상 머신(OS 위에서 동작한다)
	}
}