...
// 기본데이터 타입은 랩퍼 클래스가 존재한다 =>
// 기본데이터 타입을 지원하는 객체[형변환,타입에 대한 정보==상수,기본데이터를 처리]
		System.out.println("1+s = "+(1+s));
		System.out.println("1+s = "+(1+Integer.parseInt(s)));
		int i=1234567890;
		double d=10.123456789012345678901234567890;
		float f=10.123456789012345678901234567890f;
