...
class Car{ // com.econ.Car
	public static final double WIDTH = 250.01;
	/* 상수는 보통 정보 전달 목적으로 자주 사용되기때문에 static 필드에 선언되고 
	   어디서든 공유가 가능하다는 의미로 public을 선언한다. */
	final double HEIGHT = 500.01;
	private static final String ENGINE = "N013123G123"; // class 내부에서만 사용 가능
}
...
public class L06Static {
	...
	public static void main(String[] args) {
		...
		// static 필드는 class를 해석할 때 객체로 만든다.
