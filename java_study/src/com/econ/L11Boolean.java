...
public class L11Boolean {
	...
	public static void main(String[] args) {
		boolean b = true; 
		// 0과 1로만 이루어진 데이터지만 1byte 크기의 메모리를 참조한다.->자바가 사용하는 최소단위의 메모리크기 1byte
		// b = 1;
		// b = 0;
		// b = null;
		b = (1<0);
		...
		// if(test!==undefined){}
		test = null; // js null은 기본데이터 타입이였지만 java에서는 비어있다는 의미 그 이상이 아니다.
		System.out.println(test);
		if(test==null) {
			System.out.println("test는 null입니다.");
		}
		// if(null) if(undefined) if(0) if("") (x)
		// if(10%0.0==NaN)
