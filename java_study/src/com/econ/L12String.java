...
public class L12String {
	public static void main(String[] args) {
		...
		// const c_arr=['t','e','x','t'];
		// 배열 선언
		char[] c_arr = {'t','e','x','t'}; // "text"와 가장 비슷한 형
		...
		String t3="ABCDEFGHIJKLMNOPQRS"; // => 문자의 집합으로 바꾸세요.['A','B','C'...]
		...
		/*->자바스크립트의 문자열은 순서대로 문자를 참조하는 인덱스와 길이만 참조하고 정적 메모리에서 관리하기 때문에
		  기본형처럼 사용하는 것이다, 인덱스를 참조한다는 관점에서는 자바스크립트의 문자열도 참조형이다. 
		  자바의 문자열은 문자열 객체를 참조하고 있어 유용한 필드가 함께 존재하기 때문에 자바의 문자열은
		  절대 기본형이 될 수 없다. */
