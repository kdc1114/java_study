...
public class L14IfElse {
	...
	public static void main(String[] args) {
		...
		// 문자를 입력하고 라인 개행을 하면 라인 개행 하기 전까지 입력한 문자들을 받을 수 있다.
...
//				System.out.println("당신이 입력할 달은 "+month_arr[month_parse-1]+"입니다.");
//			}else {
...
//		}
		try {
			...
			System.out.println("당신이 입력할 달은 "+month_arr[month_p-1]+"입니다.");
		}catch(NumberFormatException e){ // 문자열을 수로 형변환 할 때 수가 될수없으면(NaN) 발생하는 오류
	...
	private static boolean stringIntTest(String a) {
		return true;
	}
