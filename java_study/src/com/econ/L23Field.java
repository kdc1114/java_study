...
class Person{
	...
	Person(){
		...
		// 부모의 자원(필드)를 상속받으면 내것이 되기 때문에 this이기도 하다.
...
public class L23Field {
	public static void main(String[] args) {
		...
		// toString은 new Person()의 필드(속성,프로퍼티)다
		// 객체지향 언어에서 필드와 같은 말
		// 멤버(변수,메소드), 상태, 특성
		// 모든 객체는 필드를 정의하고 생성자를 호출할 수 있는 최상위 설계도를       	   	       상속(위임)받는다.
		/* 최상위 설계도의 type(이름)은 java.lang.Object (Object)이고
		 * Object 필드를 사용할 수 있다.(상속)
		 */
		Person p=new Person();
