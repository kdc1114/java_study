...
class TeleVision{
	...
	// 생성자가 하는 일은 필드를 정의하고, 파라미터로 넘어온 값으로 기본값을 정의하는것
		...
		// 이름이 같은데 super or this로 다르게 접근할 수 있는 상태를 다형성이라 한다.
	}
	// 2.Object.String() 객체에 대한 설명서
	@Override // 부모의 필드를 재정의 했다는 표시
	public String toString() {
		return "저희 tv는 "+this.p.v+"볼트에서 동작하고 LED가(OLED)"+oled.length+"개 있습니다. 생잔자는 "+super.toString();
	}
	// 부모에게 물려받은 필드는 super로 접근하고
	// 부모에게 물려받았는데 재정의한 것은 this로 접근한다.
}

public class L24SuperField {
	public static void main(String[] args) {
		TeleVision tv= new TeleVision(220, 7);
		// 1. Object가 참조형 데이터를 생성하는 설계도
