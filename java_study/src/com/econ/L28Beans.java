...
class Person2{
	// mysql : Person{name:"김승겸",age:37,birth:"1994-10-08"} => java의 mysql 커넥터
	// 라이브러리가 mysql의 data를 자바의 객체로 변환
	String name;
	int age;
	Date birth;
	// 커넥터 라이브러리에서 하는 일
	...
	// getter setter로 필드를 캡슐화하는 행위(디자인패턴)이 너무 사용하기 좋아서
	// 약속으로 사용되며 자동완성을 제공한다.
...
public class L28Beans {
	...
	public static void main(String[] args) {
		...
		// 이는 디자인패턴의 일부로 통신을 할때 받아온 data를 java의 객체에 대입할때 용이
